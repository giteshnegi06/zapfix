          ...
          <div className="lg:col-span-8 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-5 sm:gap-6">
            {WHY_CHOOSE_US_FEATURES.map((feat) => (
              ...
              >
                ...
                <div className="w-14 h-14 rounded-full bg-[#dcece2] border border-[#bedecb] flex items-center justify-center mb-4 text-[#294537] group-hover:scale-110 group-hover:bg-[#c44b2b] group-hover:text-white transition-all duration-300">
