...
export const BookingModal: React.FC<BookingModalProps> = ({
  ...
  const inputClasses =
    'w-full min-w-0 bg-white border border-stone-300 rounded-lg px-3 py-2.5 text-base sm:text-sm text-stone-900 placeholder:text-stone-400 focus:outline-none focus:ring-2 focus:ring-[#294537] focus:border-transparent transition-all';

  const selectClasses =
    'w-full min-w-0 bg-white border border-stone-300 rounded-lg px-3 py-2.5 pr-9 text-base sm:text-sm text-stone-900 font-medium appearance-none cursor-pointer hover:border-[#294537] focus:outline-none focus:ring-2 focus:ring-[#294537] focus:border-transparent transition-all';
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div className="min-w-0 overflow-hidden">
                  ...
                  <input
                    ...
                    className={`${inputClasses} block box-border`}
                    required
                  />
                </div>
