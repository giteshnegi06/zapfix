        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-6 sm:gap-6 relative">
          {HOW_IT_WORKS_STEPS.map((step, idx) => (
            <div key={step.number} className="relative flex flex-col items-center">
              ...
              <div className="text-4xl sm:text-5xl font-condensed font-black text-[#588e73] mb-3 select-none">
                {step.number}
              </div>

              {/* White Card Container */}
              <div
                className="w-full bg-[#fdfbf7] text-[#1c2c22] rounded-[24px] p-6 sm:p-7 shadow-xl hover:shadow-2xl transition-all duration-300 hover:-translate-y-1.5 flex flex-col items-center text-center border border-stone-200/70 group min-h-[280px] justify-between cursor-pointer"
