...
import { Home, Shield, Battery, Wifi, Wrench, ShieldCheck } from 'lucide-react';
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 z-10">
        ...
        <div className="text-center max-w-3xl mx-auto space-y-4 mb-16 sm:mb-20">
          ...
          <div className="inline-flex items-center gap-2 px-5 py-2 rounded-full border border-stone-300 bg-white text-[#294537] text-xs sm:text-sm font-bold uppercase tracking-wider shadow-sm">
            <Wrench className="w-5 h-5 text-[#c44b2b]" />
        ...
        {/* Warranty Banner */}
        <div className="mt-10 sm:mt-14 bg-[#294537] rounded-[24px] p-6 sm:p-8 shadow-xl flex flex-col sm:flex-row items-center gap-5 sm:gap-8">
          <div className="w-14 h-14 rounded-full bg-[#c44b2b] flex items-center justify-center shrink-0">
            <ShieldCheck className="w-7 h-7 text-white" />
          </div>

          <div className="flex-1 text-center sm:text-left">
            <h3 className="text-lg sm:text-xl font-condensed font-black text-white uppercase tracking-wide">
              Backed by Our Service Warranty
            </h3>
            <p className="text-stone-300 text-xs sm:text-sm mt-1">
              Every job is covered so you can book with confidence.
            </p>
          </div>
